...
<div class="row">
    <div class="col-md-3">
        <!-- searc data by id -->
    <form action="/getDataDate" method="GET">
      ...
      <!-- searc data by id -->
      <form action="getDataCompany" method="GET">
    ...
    <form action="getDataAmount" method="GET">
    ...
    <form action="/getDataId" method="GET">
      ...
      <form action="/getDataReadStatus" method="GET">
        <label>Get contract read status</label>
        @csrf
        <div class="input-group">
            <input type="text" required class="form-control" 
                name="contract Id" placeholder="Id">
            <div class="input-group-append" id="button-addon2">
                <button class="btn btn-primary square" type="submit">
                    <i class="ft-upload mr-1"></i> Get</button>
            </div>
